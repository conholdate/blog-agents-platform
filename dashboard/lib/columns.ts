...
export const COLUMNS: ColumnDef[] = [
  ...
  { key: "question_keywords",       label: "Question KWs",   type: "bullets",  width: "240px" },
  { key: "entity_keywords",         label: "Entity KWs",     type: "bullets",  width: "240px" },
  ...
  { key: "primary_keyword_intent",  label: "KW Intent",        type: "readonly", width: "120px" },
  { key: "primary_keyword_score",   label: "KW Score",         type: "readonly", width: "80px"  },
  { key: "primary_keyword_aeo_score", label: "AEO Score",      type: "readonly", width: "80px"  },
  { key: "primary_keyword_placement", label: "KW Placement",   type: "readonly", width: "200px" },
  { key: "keyword_clusters",        label: "KW Clusters",      type: "readonly", width: "240px" },
  { key: "rejected_keywords",       label: "Rejected KWs",     type: "readonly", width: "240px" },
